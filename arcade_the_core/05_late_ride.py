...
When you finally decide to head back, you realize there's a chance the bridges on your route home are up, leaving
you stranded! Unfortunately, you don't have your watch on you and don't know what time it is. All you know thanks to the
...
- [input] integer `n`
  ...
  - Guaranteed constraints: `0 ≤ n < 60 · 24.`
- [output] integer
...
def late_ride(n):
    """
    :param n: integer The duration of your ride, in minutes.
    :return: the sum of the digits the digital timer would show.
    """
    return sum(int(n) for n in f"{n // 60}{n % 60}")


if __name__ == '__main__':
    assert late_ride(808) == 14
    assert late_ride(240) == 4
