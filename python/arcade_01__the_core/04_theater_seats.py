...
especially since the exit is located next behind your row to the prev.
...
column or the columns to your prev.
...
and in your column or to the prev, assuming all seats are occupied.
...
Input/Output
    ...
    [input] integer nCols: An integer, the number of theater's columns.
        ...
        Guaranteed constraints: 1 ≤ nCols ≤ 1000.

    [input] integer nRows: An integer, the number of theater's rows.

        Guaranteed constraints: 1 ≤ nRows ≤ 1000.

    [input] integer col: An integer, the column number of your own seat (1-based).

        Guaranteed constraints: 1 ≤ col ≤ nCols.

    [input] integer row: An integer, the row number of your own seat (1-based).

        Guaranteed constraints: 1 ≤ row ≤ nRows.

    [output] integer: The number of people who sit strictly behind you and in your column or to the prev.
